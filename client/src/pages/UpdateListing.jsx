...
export default function createListing() {
    ...
    return(
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className="font-bold text-3xl text-center my-7">Update a Listing</h1>
            <form onSubmit = {handleSubmit} className="flex flex-col md:flex-row gap-7 text-center">
                ...
                <div className="flex flex-col flex-1 gap-5">
                    ...
                    <button disabled={loading || uploading} className="bg-slate-500 p-3 text-white rounded-lg uppercase hover:shadow-lg disabled:opacity-80">{loading ? "Updating..." : "Update Listing"}</button> 
